...
{
    /// <inheritdoc />
    public partial class AddTeacherDutyFollowup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TeacherDutyFollowups",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherDutyFollowups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherDutyFollowups_TeacherProfiles_TeacherProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherDutyFollowups_TeacherProfileId",
